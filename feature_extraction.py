...
def main():
    ...
    print(lld)
    """data_path = '/Volumes/ExtremeSSD/ALC/ses1006'
    feature_llds = {}
    feature_funcs = {}
    list_files = []
    ...
    with open('/Volumes/ExtremeSSD/feature_egemaps_45/lld_feature.json', 'w') as f_lld:
        json.dump(feature_llds, f_lld, indent=4)
    with open('/Volumes/ExtremeSSD/feature_egemaps_45/func_feature.json', 'w') as f_func:
        json.dump(feature_funcs, f_func, indent=4)
    
    with open('/Volumes/ExtremeSSD/list_files.json', 'w') as f_files:
